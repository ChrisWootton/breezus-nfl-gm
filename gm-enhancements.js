/* Breezus NFL GM v5.7 loader - premium dynasty UI */
(function(){
'use strict';
...
function load(src){return new Promise(function(resolve,reject){var s=document.createElement('script');s.src=src+'?v=5.7-'+Date.now();s.onload=resolve;s.onerror=reject;document.head.appendChild(s)})}
