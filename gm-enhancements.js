/* Breezus NFL GM v5.6 loader - defense engine + restored Defense navigation */
(function(){
'use strict';
...
function load(src){return new Promise(function(resolve,reject){var s=document.createElement('script');s.src=src+'?v=5.6.1-'+Date.now();s.onload=resolve;s.onerror=reject;document.head.appendChild(s)})}
