...
function boot(){
  ...
  load('gm-product-v1.js').then(function(){return load('gm-v7-playbook.js').then(function(){return load('gm-v7-trade-analyzer.js').then(function(){return load('gm-v7-rankings.js')})})}).catch(function(e){console.error('NFL GM decision centre failed',e)});
