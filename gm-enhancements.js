/* Breezus NFL GM App v4.0 loader - unified engine only */
(function(){
'use strict';
...
function boot(){var started=Date.now();(function wait(){if(ready())return load('gm-app-v40.js').catch(console.error);if(Date.now()-started<20000)return setTimeout(wait,200);console.error('NFL GM: Sleeper data unavailable')})()}
